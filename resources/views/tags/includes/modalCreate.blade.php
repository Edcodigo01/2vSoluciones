  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h2 class="text-white"><i class="fas fa-list"></i> Agregar Etiqueta</h2>
      ...
      <form class="formula validate" action="{{route('administrar-etiquetas.store')}}" method="post" id="create">
